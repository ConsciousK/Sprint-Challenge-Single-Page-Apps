...
> Answer: Client-side routing is extremely beneficial because it allows an application to 'preload' all of its data. Response time goes up, and multiple HTTP requests are not made.  
